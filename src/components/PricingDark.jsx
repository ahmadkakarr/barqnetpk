    ...
    return (
        <div className="bg-gray-900 py-24 sm:py-32">
            <div className="mx-auto max-w-7xl px-1 sm:px-2 lg:px-8">
                ...
                <div className="isolate mx-auto mt-10 grid max-w-md grid-cols-2 gap-4 px-1 sm:grid-cols-1 sm:gap-4 sm:px-2 lg:mx-0 lg:max-w-none lg:grid-cols-3 lg:px-8">                    {tiers.map((tier) => (
                    <div
                        key={tier.id}
                        className={classNames(
                            tier.mostPopular ? 'bg-white/5 ring-2 ring-indigo-500' : 'ring-1 ring-white/10',
                            'rounded-3xl p-2 xl:p-10',
                        )}
                    >
